            ...
            <div class="col-lg-3 col-md-3 col-sm-3">
                <div class="product-left">
                    <div class="beds-section bg-bd">
                        <h4 class="pp-left-heading">奶粉</h4>
                                ...
                                <div class="row">
                                    <div class="right-all-product">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                            <div class="single-product">
                                                <div class="product-image">
                                                    <a href="#"><img src="../../../img/product/1200g.jpg"
                                                                     alt=""/>
                                                    </a>
                                                    <div class="efface"></div>
                                                    <div class="cart-box">
                                                ...
                                                <div class="price-box">
                                                    <a href="#"><p>美素佳儿（Friso）较大婴儿配方牛奶粉</p></a>
                                                    <div class="price">
                                                        <a href=""><h5>280</h5></a>
                                                    </div>
                                                </div>
                                        ...
                                        <ul>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                        <div class="price-box">
                                                            ...
                                                            <p class="desc">Faded short sleeves t-shirt with high
                                                                neckline. Soft and stretchy material for a comfortable
                                                                fit. Accessorize with a straw hat and you're ready for
                                                                summer! </p>
                                                            <div class="action">
                                                                <div class="cart-box">
                                                                    <div class="product-text">
                                            ...
                                            <li>
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        <div class="product-image">
                                                            <a href="#"><img src="../../../img/product/blouse.jpg.png" alt=""/>
                                                            </a>
                                                        </div>
                                                        <a href="#"><span class="leval">new</span></a>
                                                    </div>
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                        <div class="price-box">
                                                            <a href="#"><p class="price-box-heading">Chiffon Dress</p>
                                                            </a>
                                                            <div class="price">
